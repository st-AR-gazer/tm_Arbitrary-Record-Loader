...
namespace Help {
    ...
    void Render() {
        ...
        UI::PushTextWrapPos();
        UI::Text("Arbitrary Record Loader");
        UI::TextDisabled("Load ghosts and replays into Trackmania from local files, URLs, official sources, ranked leaderboards, and current-map tooling.");
        UI::PopTextWrapPos();
